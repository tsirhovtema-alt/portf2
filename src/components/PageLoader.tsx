...
export default function PageLoader() {
  ...
  useEffect(() => {
    /* JS fallback — removes element from DOM after CSS animation finishes */
  ...
  return (
    <>
      ...
      {/* Overlay — CSS drives the fade-out, no JS required */}
      <div style={{
        position:       'fixed',
        inset:          0,
        zIndex:         9500,
        ...
        <p style={{
          fontSize: '1rem', fontWeight: 900, letterSpacing: '.15em',
          color: 'rgba(255,255,255,0.5)', fontFamily: 'monospace', margin: 0,
        }}>
          WEB TERA
        </p>
        ...
        <div style={{
          width: 160, height: 1, background: 'rgba(255,255,255,0.1)',
        ...
        <p style={{
          fontSize: '.65rem', letterSpacing: '.25em', textTransform: 'uppercase',
          color: 'rgba(255,255,255,0.3)', fontFamily: 'monospace', margin: 0,
        }}>
          Загрузка
        </p>
      </div>
